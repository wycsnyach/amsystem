<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="header"><strong>MANAGE</strong></li>
        ...
        <li class="header"><strong>PRINTABLES</strong></li>
         <li><a href="schedule_employee.php"><i class="fa fa-clock-o"></i> <span>Schedule</span></a></li>
          <li><a href="attend_ontime.php"><i class="fa fa-clock-o"> </i><span>Ontime Employees</span> </a> </li>
          <li><a href="attend_late.php"><i class="fa fa-clock-o"> </i><span>Late Employees</span> </a> </li>
          <li><a href="attend_today.php"><i class="fa fa-clock-o"> </i><span>Today Attendance</span> </a> </li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>